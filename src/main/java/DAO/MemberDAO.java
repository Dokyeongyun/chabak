...
import RowMapper.Chabak.ChabakRowMapper;
import RowMapper.Chabak.ReviewRowMapper;
import Util.crypto.CryptoUtil;
...
public class MemberDAO {
    ...
    public String jjimDo(String memberId, int placeId, String placeName) {
        ...
        int result = jdbcTemplate.update(sql, memberId, placeId, placeName);
        if(result>0){
            return "success";
        }else{
            return "false";
